                    ...
                    <div className="portfolio__content">
                        ...
                        <div className="portfolio__content-ex">
                            <p className="portfolio__content-ex-text">
                                ...
                                CSS문법의 가독성을 올리고 유지보수를 빠르게 하기 위해 SASS를 사용했습니다.
                                하지만 몇몇 modal이나 일부 input은 Bootstrap으로 만들면서 진행했었습니다. CSS와 부트스트랩을 한 번에 사용하면 디자인 커스텀이 어렵다는 걸
                            ...
                            <p className="portfolio__content-ex-text">
                                ...
                                특히 여기저기서 게시판의 데이터를 불러올 때 비효율적인 작업을 많이 하면서 더 쉽게 할 수 있을 것 같은데라는 생각과 동시에 Javascript의 중요성을 많이 느꼈습니다.
                                Vue를 하면서 CkEditor(라이브러리) 파트를 제외한 모든 부분을 전부 Composition API로 작성했는데 그 이유는 앞으로 나올 Vue의 레퍼런스나 라이브러리가
                                Composition API의 문법으로 작성될 거라 생각해서입니다. 하지만 백엔드와 협의하에 사용한 CKEditor를 Composition API로
                                ...
                                아예 차근차근 맞춰가며 협업을 했습니다. 이때의 경험은 아 백엔드의 이런 부분들을 진작 알았으면 좋았을 걸이라는 생각이 드는 부분이 많았습니다.
                                그래서 왜 프론트엔드 개발자도 백엔드 지식이 필요한지, 그리고 웹에서 요구하는 전체적인 개발 지식이 필요한지 이유를 알 수 있었습니다.
                                <br />
                                <br />
                                이번 프로젝트를 통해 백엔드와 협업하는 과정에서 어떻게 교류를 해야 하고 소통해야 하는지 수많은 시행착오를 겪으며 알 수 있었고,
