                    ...
                    <div className="portfolio__content">
                        ...
                        <div className="portfolio__content-ex">
                            <p className="portfolio__content-ex-text">
                                ...
                                CSS문법의 가독성을 올리고 유지보수를 빠르게 해줄 라이브러리가 필요해 SASS를 사용했습니다.
                                ...
                                일부 컴포넌트를 Bootstrap의 인라인 스타일 방식으로 만들었습니다.
                            </p>
                            <p className="portfolio__content-ex-text">
                                ...
                                요구사항을 말하며 협업했던 경험은 왜 프론트엔드 개발자가 웹에서 요구하는 전체적인 개발 지식이 필요한지 이유를 알 수 있었습니다.
                                <br />
                                <br />
                                백엔드와 협업하는 과정에서 어떻게 교류를 해야 하고 소통해야 하는지 여러가지 시행착오를 겪으며 알 수 있었고,
